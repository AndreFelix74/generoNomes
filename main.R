...
ui <- fluidPage(
  ...
  fluidRow(
    column(4, fileInput('fileWithNames', label = 'Escolha o arquivo', buttonLabel = 'Procurar', placeholder = 'Nenhum arquivo selecionado',
                  accept = c(
                    'text/csv',
    ...
    column(4, checkboxInput('firstRowIsHeader', 'Primeira linha do arquivo contem cabecalhos de coluna.', TRUE)),
    column(4, uiOutput('columnName'))),
  fluidRow(
